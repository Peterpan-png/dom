...
var div = dom.create("<div><span>使用create创建的第一个标签节点</span></div>");
console.log(div);
var after = dom.create("<div><span>用after插入的测试</span></div>");
dom.after(test, after);
var before = dom.create("<div><span>用before插入的测试</span></div>");
...
console.log(testDiv);
console.log(dom.parent(test)); // const t = dom.find('#travel')[0]
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12290" + '/');
